			...
			BEGIN
				SELECT 'Customers table is not populated - Inserting values.' AS CustomersTableStatus
					...
					VALUES('Yvonne', 'McKay', '1984-05-25', 9000, NULL, NULL, GETDATE()),
						  ('Jossef', 'Basmati', '1995-07-04', 5500, NULL, NULL, GETDATE()),
						  ('Ana', 'Nguyen', '1991-07-04', 7500, NULL, NULL, GETDATE())
			END
	END TRY
	BEGIN CATCH
...
--Create OrdersInsert stored procedure
		...
		ELSE
			BEGIN
				SELECT 'Orders table is not populated - Inserting values.' AS OrdersTableStatus
					INSERT INTO BusinessDatabase.dbo.Orders(CustomerID, OrderDate, Item)
					VALUES('1', '2020-5-18', 'BlackHat'),
						  ('1', '2020-6-16', 'GreyHat'),
						  ('2', '2020-7-28', 'WhiteHat')
			END
	END TRY
	BEGIN CATCH
